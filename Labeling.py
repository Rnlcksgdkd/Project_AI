{
  ...
  "metadata": {
    "colab": {
      "name": "Labeling.py",
      "provenance": [],
      "authorship_tag": "ABX9TyPo8kjoaRH30QFt1cuULSIv",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Rnlcksgdkd/Project_AI/blob/main/Labeling.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
